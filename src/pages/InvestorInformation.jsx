...
import pdf from '../assets/TheRedBladeDAO-IRInformation.pptx.pdf'
...
function InvestorInformation() {
  ...
  return (
    <div>
      <Document file="../assets/TheRedBladeDAO-IRInformation.pptx.pdf" onLoadSuccess={onDocumentLoadSuccess}>
