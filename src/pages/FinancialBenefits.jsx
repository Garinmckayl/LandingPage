                        ...
                        <div className="col-xl-6 col-md-12">
                            <div className="content-right">
                                <div className="sc-item-details">
                                    ...
                                    <h5>No matter what the game is, WoW, Eldenring, CS, Fortnite, Roblox. We got you covered. 
                        ...
                        <div className="col-xl-6 col-md-12">
                            <div className="content-right">
                                <div className="sc-item-details">
                                    ...
                                    <h5>The recent craze with blockchain-based games has led to new models, where players need to make major upfront payments. This is not always affordable, so we want to help out. The Red Blade has a selection of blockchain-based games where players can apply for scholarships. These scholarships are agreements about future revenues that the scholar will generate with his game-play. As a Red Blade token holder you can use your tokens as a form of financing for these players and receive interest from this lending approach.</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-xl-6 col-md-12">
                            <div className="content-right">
                                <div className="sc-item-details">
                                    ...
                                    <h5>You can invest your new Red Blade tokens into existing blockchain services. The most common is to stake your tokens. We explain here how staking works, and why it is comparatively safe to deposit your crypto currency. 
                        ...
                        <div className="col-xl-6 col-md-12">
                            <div className="content-right">
                                <div className="sc-item-details">
                                    ...
                                    <h5>To trade your Red Blade tokens outside our platform, you will have to connect your crypto wallet. We support all standard wallet integrations like Metamask, Coinbase, Trust Wallet, Binance Wallet or Safepal.
</h5>
                                </div>
                            </div>
                        </div>
