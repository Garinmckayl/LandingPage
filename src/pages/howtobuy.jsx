...
{/* <div
  className="row no-gutters clients-wrap clearfix wow fadeInUp howto-container align-center justify-content-center mb-4"
    ...
    <div className="row align-center justify-content-center">
      <div className="p-3 col-12 col-md-6 col-lg-3">
        <div className="client-wrapper">
          <div className="wrap-img client-logo">
            <img
              src="https://uploads-ssl.webflow.com/5f9a1900790900e2b7f25ba1/60f6c47070e683cb60fd647f_Sushiswap.png"
